...
$('#btnBuscar').click(function () {
    ...
    tabla = $('#reporte_data').dataTable({
        ...
        "ajax": {
            ...
            type: "POST",
            data: { repdia_user: repdia_user, repdia_vehi: repdia_vehi, repdia_obra: repdia_obra, fecha_inicio: fecha_inicio, fecha_final: fecha_final },
            dataType: "json",
            error: function (e) {
                console.log(e.responseText);
            }
...
$('#btnLimpiar').click(function () {
    ...
    $('#repdia_obra').val('--Selecciona el Conductor--').trigger('change');
});
