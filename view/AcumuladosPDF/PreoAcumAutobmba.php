...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->SetY(15);
        $this->SetX(70);
        $this->Cell(60, 10, 'Formato Preoperacional De Autobomba de Concreto', 0, 0, 'C');
        $this->Ln(25);
    }
    ...
    foreach ($agrupado_por_formulario as $formulario => $operaciones) {
        foreach ($operaciones as $operacion) {
            ...
            if ($Fecha != $ultima_fecha) {
                ...
                $pdf->Cell(100, 20, 'Elemento', 1, 0, 'C', 1);
                ...
                $pdf->Ln(10);
                $pdf->SetFont('Arial', '', 9);
                $pdf->Cell(40, 128, 'Autobomba', 1, 0, 'C', 1);
                ...
                foreach ($operaciones as $operacion) {
                    ...
                    $pdf->SetX(50);
                    $pdf->Cell(100, 4, utf8_decode($operacion['suboper_nombre']), 1, 0, 'L', 0);
                    $pdf->SetX(150);
