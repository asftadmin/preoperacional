...
$rol = new Rol();
$datos = $rol->validacion_acceso($_SESSION["user_id"],"Licencias");
...
<body class="hold-transition sidebar-mini">
            ...
            <table id="cond_data" name="cond_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
              <thead class="bg-info">
                <tr>
                  ...
                  <th th class="text-center"  style="width: 4%;">Nº PLACA</th>
  ...
  <?php require_once ("crudLicencias.php")?>
  <?php require_once ("../MainJS/JS.php")?>
  <script type="text/javascript" src="crudLicencias.js"></script>
</body>
</html>
<?php
}else {
