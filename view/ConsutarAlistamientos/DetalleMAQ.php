...
<html lang="es">
    ...
    <title>Detalle Alistamiento</title>
</head>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Consultar Alistamiento</li>
                <li class="breadcrumb-item active">Detalle Maquinaria</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          ...
          <div id="" class="card-body" >
            ...
            <button class="btn btn-info" onclick="goBack()">Volver</button><br><br>
              <table id="detalleMAQ_data" name="detalleMAQ_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                <thead class="bg-info">
                  <tr>
                    <th th class="text-center"  style="width: 8%;">TIPO</th>
                    <th th class="text-center"  style="width: 15%;">MARCA</th>
                    <th th class="text-center"  style="width: 8%;">PLACA</th>
                    <th th class="text-center"  style="width: 8%;">ASIGANDO</th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript" src="DetalleMAQ.js"></script>
</body>
</html>
