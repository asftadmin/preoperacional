...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->SetY(15);
        $this->SetX(70);
        $this->Cell(60, 10, 'Formato Preoperacional Semanal de Volqueta', 0, 0, 'C');
        $this->Ln(25);
    }
    ...
    foreach ($agrupado_por_formulario as $formulario => $operaciones) {
        foreach ($operaciones as $operacion) {
            ...
            if ($Fecha != $ultima_fecha) {
                ...
                $pdf->Ln(12);
                $pdf->Cell(40, 36, 'Sistema Electrico', 1, 0, 'C', 1);
                $pdf->Ln(36);
                $pdf->Cell(40, 12, 'Sistema De Frenos', 1, 0, 'C', 1);
                $pdf->Ln(12);
                $pdf->Cell(40, 30, 'Sistema Mecanico', 1, 0, 'C', 1);
                $pdf->Ln(30);
                $pdf->Cell(40, 15, 'Sistema de Rodamiento', 1, 0, 'C', 1);
                $pdf->Ln(15);
                $pdf->Cell(40, 12, 'Trailer', 1, 0, 'C', 1);
                $pdf->Ln(12);
                $pdf->Cell(40, 33, 'Seguridad y Otros', 1, 0, 'C', 1);
