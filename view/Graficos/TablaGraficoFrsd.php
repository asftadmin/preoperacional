        ...
        <div class="container-fluid">
          <div class="card">
            <br>
              ...
              <caption style="caption-side: top; font-size: 1.5em; font-weight: bold; text-align:center;">RENDIMIENTO M3/HOROMETRAJE TRABAJADO</caption>
                <thead class="bg-info">
                  <tr>
                    ...
                    <th th class="text-center"  style="width: 8%;">HOROMETRAJE TRABAJADO</th>
...
<script type="text/javascript" src="TablaGraficoFrsd.js"></script>
