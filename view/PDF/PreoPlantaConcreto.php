...
GROUP BY suboperaciones.suboper_nombre, preoperacional.pre_repuesta, operaciones.oper_nombre, 
         ...
         preoperacional_anterior.pre_kilometraje_inicial, preoperacional.pre_fecha_crea_form,suboperaciones.suboper_id,
...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(30, 5, '13 Julio 2020', 0, 1, 'L');

        $this->SetX(150);
        $this->Cell(30, 5, 'Codigo:', 0, 0, 'R');
        $this->Cell(30, 5, 'ME-F-36', 0, 1, 'L');
        ...
        $this->SetY(15);
        $this->SetX(70);
        $this->Cell(60, 5, 'INSPECCION PREOPERACIONAL DIARIA', 0, 0, 'C');
        $this->Ln(2);
        $this->Cell(185, 10, 'PLANTA DOSIFICADORA DE CONCRETO', 0, 0, 'C');
        $this->Ln(25);
    }
...
foreach ($operaciones as $index => $operacion) {
    ...
    elseif ($contador == 12) {
        $texto = 'BANDA TRANSPORTADRA';
    }
    elseif ($contador == 25) {
        $texto = 'BASCUA PARA AGREGADOS';
    }
    elseif ($contador == 37) {
        $texto = 'BASCULA PARA CEMENTO';
    }
    elseif ($contador == 49) {
        $texto = 'COMPRESOR';
    }
    elseif ($contador == 53) {
        $texto = 'SISTEMA DOSIFICADO DE AGUA';
    }
    elseif ($contador == 61) {
        $texto = 'GABINETE ELECTRICO';
    }
    elseif ($contador == 66) {
        $texto = '.';
    }
    ...
    elseif ($contador == 76) {
        $texto = 'FECHA CAIBRACION EQUIPOS';
    }
