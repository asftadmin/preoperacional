...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Detalle Herramienta Menor</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div id="" class="card-body">
              <div class="box-typical box-typical-padding">
                <button class="btn btn-info" id="btnvlver">Volver</button><br><br>
  ...
  <?php require_once("crudCambioEstado.php") ?>
  <?php require_once("../MainJS/JS.php") ?>
  <script type="text/javascript" src="crudCambioEstado.js"></script>
  <script type="text/javascript" src="DetalleHM.js"></script>
</body>
