...
ORDER BY
    CASE 
        ...
        WHEN operaciones.oper_nombre like 'Seguridad y%' THEN 5
        ELSE 6
    END,
    operaciones.oper_nombre, preoperacional.pre_fecha_crea_form DESC;";
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->SetY(15);
        $this->SetX(70);
        $this->Cell(60, 10, 'Formato Preoperacional Semanal de Vehiculos', 0, 0, 'C');
        $this->Ln(25);
    }
    ...
    foreach ($agrupado_por_formulario as $formulario => $operaciones) {
        foreach ($operaciones as $operacion) {
            ...
            if ($Fecha != $ultima_fecha) {
                ...
                $pdf->Cell(40, 5, 'Placa: ' . $placa, 1, 0, 'L', 0);
                $pdf->Cell(40, 5, 'Modelo' . '   ' . $modelo, 1, 0, 'L', 0);
                ...
                $pdf->Cell(100, 5, 'Licencia (Categoria):' . '   ' . $categoria, 1, 0, 'L', 0);
                ...
                $pdf->Ln(15);
                $pdf->Cell(40, 24, 'Sistema Electrico', 1, 0, 'C', 1);
                $pdf->Ln(24);
                $pdf->Cell(40, 9, 'Sistema De Frenos', 1, 0, 'C', 1);
                $pdf->Ln(9);
                $pdf->Cell(40, 21, 'Sistema Mecanico', 1, 0, 'C', 1);
                $pdf->Ln(21);
                $pdf->Cell(40, 30, 'Seguridad y Otros', 1, 0, 'C', 1);
