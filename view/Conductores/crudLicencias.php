                ...
                <input type="hidden" id="cond_id" name="cond_id">
                    <div class="form-group">
                      <label for="conductor_usuario">Nombre del Conductor:<sup>*</sup></label>
                        <select class="form-control select2bs4" id="conductor_usuario" name="conductor_usuario" style="width: 100%;" disabled required>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="conductor_vehiculo">Vehiculo:<sup>*</sup></label>
                        <select class="form-control select2bs4" id="conductor_vehiculo" name="conductor_vehiculo" style="width: 100%;" disabled  required>
                        </select>
                    </div>
                </div>
