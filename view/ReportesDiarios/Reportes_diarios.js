                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.status.trim().toLowerCase() == 'errores') {
                            ...
                            // Limpiar únicamente cuando guardó correctamente
                            document.getElementById('repdia_form').reset();
                        }
                    },
                    ...
                    error: function () {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'No fue posible guardar el reporte. Intente nuevamente.',
                        });
                    },
                });
            }
...
$.post('../../controller/Usuario.php?op=comboUsuarioResidente', function (data, status) {
