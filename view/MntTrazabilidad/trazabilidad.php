...
<body class="hold-transition sidebar-mini layout-fixed">
                                            ...
                                            <tr class="fila-detalle" data-fila="0">
                                                ...
                                                <td data-casilla="1">
                                                    <select class="form-control form-control-sm select2-volqueta"
                                                        name="detalle[0][placa_volqueta]" data-campo="placa_volqueta">
                                                        <option value="">
                                                            Seleccione...
                                                        </option>
                                                    </select>
                                                    ...
                                                    <tr class="fila-llegada" data-fila="0">
                                                        ...
                                                        <td>
                                                            <select
                                                                ...
                                                                name="llegada[0][placa_volqueta]"
                                                                data-campo="placa_volqueta" style="width: 100%;">
                                                                <option value="">
                                                                    Seleccione...
                                                                </option>
                                                            </select>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <!-- Cancelar -->
                                    <button type="button" class="btn btn-default" id="btn_cancelar">
                                    ...
                                    <div>
                                        ...
                                        <!-- Guardar borrador -->
                                        <button type="button" class="btn btn-secondary mr-2" id="btn_guardar_borrador">
                                            <i class="fas fa-save mr-1"></i>
                                            Guardar borrador
                                        </button>

                                        <!-- Enviar a aprobación -->
                                        <button type="button" class="btn btn-primary" id="btn_enviar_aprobacion">
    ...
    <script src="trazabilidad.js"></script>
