          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Ver Preoperacionales</a></li>
        ...
        <div class="container-fluid">
          ...
          <div id="" class="card-body" >
            ...
            <button class="btn btn-info" onclick="goBack()">Volver</button><br><br>
              <table id="detalle_data" name="pre_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                <thead class="bg-info">
                  <tr>
                    ...
                    <th th class="text-center"  style="width: 15%;">SUBOPERACIÓN</th>
              ...
              <table id="detalleForm_data" name="detalleForm_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                <thead class="bg-info">
                  <tr>
                    <th th class="text-center"  style="width: 8%;">OPERACIÓN</th>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    <label for="pre_kilometraje_inicial">Horometro Inicial:</label>
                    <input id="pre_kilometraje_inicial" name="pre_kilometraje_inicial"  style="font-size:14px;" disabled>
                  </div>
              </div>
              <?php }else  { ?>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    <label for="pre_kilometraje_inicial">Kilometraje Inicial:</label>
                    <input id="pre_kilometraje_inicial" name="pre_kilometraje_inicial"  style="font-size:14px;" disabled>
                  </div>
              </div>
              <?php }?>
              ...
              <div class="col-md-12">
              <div class="form-group">
                  <label for="pre_observaciones">Observaciones:</label><br>
                  <textarea id="pre_observaciones" name="pre_observaciones" style="font-size:14px; resize: none; width: 100%;" rows="10"  autocapitalize="sentences" spellcheck="true" disabled></textarea>
                </div>
              </div>
