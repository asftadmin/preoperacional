...
$rol = new Rol();
$datos = $rol->validacion_acceso($_SESSION["user_id"], "check");
...
?>
    ...
    <body class="hold-transition sidebar-mini bodyPreop">
        <div class="wrapper">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Formulario Chekeo</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <section class="content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <form id="formulario_check">
                                        <!-- CARD HEADER -->
                                        <div class="card-header bg-gray mt-0">
                                            <div class="row mt-2">
                                                <div class="col-md-4">
                                                    <div class="form-group d-flex align-items-center">
                                                        <label for="select_placa" class="mr-2">Equipo:</label>
            ...
            <?php require_once("../Preoperacional/modalFirmaPreoperacional.php") ?>

            <script src="../../public/plugins/select2/js/select2.full.min.js"></script>
            <script type="text/javascript" src="../Preoperacional/firmaPreoperacional.js"></script>
